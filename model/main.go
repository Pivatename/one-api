...
func InitDB() {
    ...
    logger.SysLog("database migration skipped for Vercel speedup")
    logger.SysLog("database migration finished (skipped)")
}
...
func InitLogDB() {
    ...
    logger.SysLog("secondary database migration skipped")
    logger.SysLog("secondary database migrated (skipped)")
}
...
func setDBConns(db *gorm.DB) *sql.DB {
    ...
    sqlDB.SetMaxIdleConns(env.Int("SQL_MAX_IDLE_CONNS", 2))
    sqlDB.SetMaxOpenConns(env.Int("SQL_MAX_OPEN_CONNS", 2))
